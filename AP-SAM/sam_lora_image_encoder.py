# copy from SAMed https://github.com/hitachinsk/SAMed/blob/main/sam_lora_image_encoder.py
# And this is used for H-SAM
from segment_anything_single_decode_cnn import build_sam, SamPredictor
from segment_anything_single_decode_cnn import sam_model_registry
...
from segment_anything_single_decode_cnn.modeling import Sam

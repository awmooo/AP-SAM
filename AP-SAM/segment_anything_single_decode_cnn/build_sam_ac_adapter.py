...
from .modeling import ImageEncoderViT,ImageEncoderViT_adapter, MaskDecoder, PromptEncoder, Sam, Sam_Twostage, TwoWayTransformer,MaskDecoder2
...
def _build_sam(
    ...
    sam = Sam_Twostage(
        image_encoder=ImageEncoderViT_adapter(
            depth=encoder_depth,
        ...
        prompt_encoder=PromptEncoder(
            ...
            mask_in_chans=16,
            auto_maskgenerater = TwoWayTransformer(
                depth=1,

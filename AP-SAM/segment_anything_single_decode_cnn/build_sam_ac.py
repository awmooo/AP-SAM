...
from .modeling import ImageEncoderViT, MaskDecoder, PromptEncoder, Sam, Sam_Twostage, TwoWayTransformer,MaskDecoder2
...
def _build_sam(
    ...
    sam = Sam_Twostage(
        ...
        mask_decoder=MaskDecoder(
            ...
            transformer_cnn=TwoWayTransformer(
                depth=2,
                embedding_dim=prompt_embed_dim,
                mlp_dim=2048,
                num_heads=8,
        ...
        mask_decoder2=MaskDecoder2(
            ...
            transformer2=TwoWayTransformer(
                depth=1,
                embedding_dim=prompt_embed_dim //4,
                mlp_dim=1024,
                num_heads=4,
            ),

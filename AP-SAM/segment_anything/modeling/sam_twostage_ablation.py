...
class Sam_Twostage_ablation(nn.Module):
    ...
    def forward(
        ...
        for image_record, curr_embedding\
                in zip(batched_input, image_embeddings):
            ...
            iou_predictions,upscaled_img_embedding,up_cnn_src , ac_token ,masks= self.mask_decoder(
